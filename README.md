...
Adding correlated features violates the conditional independence assumption of Naive Bayes,causing the model to double count evidence and artificially inflate confidence.
